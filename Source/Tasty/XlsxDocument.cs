//-----------------------------------------------------------------------
// <copyright file="XlsxDocument.cs" company="Tasty Codes">
...
namespace Tasty
{
    ...
    public class XlsxDocument
    {
        ...
        private void CreateParts(SpreadsheetDocument document)
        {
            ...
            this.GenerateExtendedFilePropertiesPart1Content(extendedFilePropertiesPart1);

            WorkbookPart workbookPart1 = document.AddWorkbookPart();
            this.GenerateWorkbookPart1Content(workbookPart1);

            WorkbookStylesPart workbookStylesPart1 = workbookPart1.AddNewPart<WorkbookStylesPart>("rId5");
            this.GenerateWorkbookStylesPart1Content(workbookStylesPart1);

            ThemePart themePart1 = workbookPart1.AddNewPart<ThemePart>("rId4");
            this.GenerateThemePart1Content(themePart1);
        ...
        private void GenerateWorkbookPart1Content(WorkbookPart workbookPart1)
        {
            ...
            WorkbookView workbookView1 = new WorkbookView() { XWindow = 120, YWindow = 120, WindowWidth = (UInt32Value)24915U, WindowHeight = (UInt32Value)12075U };
