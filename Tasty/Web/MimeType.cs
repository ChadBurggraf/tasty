//-----------------------------------------------------------------------
// <copyright file="MimeType.cs" company="Chad Burggraf">
...
namespace Tasty.Web
{
    ...
    public class MimeType
    {
        ...
        {
            this.ContentType = contentType.ToLowerInvariant();
            this.Extensions = new ReadOnlyCollection<string>((from ext in extensions
        ...
        public void AddExtension(string extension)
        {
            ...
            if (!this.Extensions.Contains(extension, StringComparer.OrdinalIgnoreCase))
            {
                List<string> temp = new List<string>(this.Extensions);
                temp.Add(extension);

                this.Extensions = new ReadOnlyCollection<string>(temp);
            }
        }
        ...
        {
            return this.Extensions.Contains(GetNormalizedExtension(extension), StringComparer.OrdinalIgnoreCase);
        }
